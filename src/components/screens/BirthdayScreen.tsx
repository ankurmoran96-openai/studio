    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-12 animate-in fade-in duration-1000 delay-500 fill-mode-both p-4 pt-16 md:pt-24 min-h-screen overflow-y-auto">
        ...
        <div className="relative">
            ...
            <Sparkles className="absolute -top-4 -left-8 w-8 h-8 text-accent opacity-80" />
            <Sparkles className="absolute -bottom-4 -right-8 w-8 h-8 text-primary opacity-80" />
        </div>
        ...
        <Card className="relative max-w-xl w-full bg-card/50 backdrop-blur-md border-primary/20 text-center mt-32 mb-16 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-1000 fill-mode-both shadow-lg shadow-primary/10">
